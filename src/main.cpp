      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          // j[1] is the data JSON object
			...
			if(pp.debug) cout << "[" << iter << "] initPathPlanning done" << endl;
